...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1 class="spacing movietitle">AT HOME <font color="EA6630"><b>ON DVD + BLU-RAY</b></font></h1>
            ...
            <ul class="spacing nav nav-pills">
                ...
                <li class="active" role="presentation"><a href="/danfango/athomedvd"><h3>At Home</h3></a></li>
            </ul>

            <div class = "slider2">
                <c:forEach items="${dvds}" var="dvd" varStatus="loop" step="12">
                    <div class="slide"> 
                        <div class="row spacing">
                            <c:forEach begin="0" end="11" step="3" varStatus="loop2"> 
                                <c:if test="${not empty dvds[loop.index+loop2.index]}">
                                    <div class = "col-md-3">
                                        <a class="" href="movieinfopage/${dvds[loop.index + loop2.index].id}">
                                            <img class ="posters" src="https://image.tmdb.org/t/p/w500/${dvds[loop.index + loop2.index].poster}">
                                        </a>
                                        <a class="" href="movieinfopage/${dvds[loop.index + loop2.index+1].id}">
                                            <img class ="posters" src="https://image.tmdb.org/t/p/w500/${dvds[loop.index + loop2.index+1].poster}">
                                        </a>
                                        <a class="" href="movieinfopage/${dvds[loop.index + loop2.index+2].id}">
                                            <img class ="posters" src="https://image.tmdb.org/t/p/w500/${dvds[loop.index + loop2.index+2].poster}">
                                        </a>
